...
/**
 * GET /api/insert-data
 * Inserta usuarios, módulos y permisos en Supabase
 * (asume que las tablas ya existen)
 */
export async function GET() {
  ...
  if (!supabaseUrl || !supabaseKey) {
    return NextResponse.json({ success: false, error: 'Credenciales faltantes' })
  }
  ...
  try {
    ...
    // Insertar usuarios con upsert (insert or update)
